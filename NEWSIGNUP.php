...
<body class="u-body" style="background-color: #f3f3f3;">
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <!-- newform -->  <section class="u-clearfix u-section-1" id="sec-42b3">
            
            <!-- new -->
            <div class="u-form u-form-1">
                <form action="NEWSIGNUP.php" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
                    <?php echo display_error(); ?>
                    <h4 class="u-text u-text-3" > &nbsp;&nbsp; Name</h4>
                    <div class="u-form-group u-form-group-2">
                        <label for="text-b611" class="u-form-control-hidden u-label"></label>
                        <input type="text" value="<?php echo $username; ?>" placeholder="ENTER NAME" id="text-b611" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                    </div>
                    <h4 class="u-text u-text-3">&nbsp; &nbsp;Email</h4>
                    <div class="u-form-group u-form-group-2">
                        <label for="text-b611" class="u-form-control-hidden u-label"></label>
                        <input type="text" value="<?php echo $email; ?>" placeholder="ENTER EMAIL" id="text-b611" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                    </div>
                    <h4 class="u-text u-text-3">&nbsp; &nbsp;Password</h4>
                    <div class="u-form-group u-form-group-3">
                        <label for="text-7960" class="u-form-control-hidden u-label"></label>
                        <input type="password" placeholder="PASSWORD" id="text-7960" name="password1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                    </div>
                    <h4 class="u-text u-text-3">&nbsp; &nbsp;Confirm Password</h4>
                    <div class="u-form-group u-form-group-4">
                        <label for="text-dc36" class="u-form-control-hidden u-label"></label>
                        <input type="password" placeholder="CONFIRM PASSWORD" id="text-dc36" name="password2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                    </div>

                    <h4 class="u-text u-text-3" > &nbsp;&nbsp; School Name</h4>
                    <div class="u-form-group u-form-group-2">
                        <label for="text-b611" class="u-form-control-hidden u-label"></label>
                        <input type="text" value="<?php echo $schoolname; ?>" placeholder="ENTER SCHOOL" id="text-b611" name="school" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                    </div>
                   
                    <div>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p>&nbsp;&nbsp;Are you teacher or student?</p>
                          &nbsp;&nbsp;<input type="radio" id="html" name="studentorteacher" value="student">
                        <label for="html">Student</label><br>
                        &nbsp;&nbsp;<input type="radio" id="css" name="studentorteacher" value="teacher">
                        <label for="css">Teacher</label><br>
                      <div>
                        &nbsp;&nbsp;<label for="quantity">Enter your age: &nbsp;&nbsp;  </label>
                        &nbsp;&nbsp;<input type="number" id="quantity" name="age" min="10" max="60">  
                    </div>
            ...
            <h3 class="u-text u-text-2">Already Have Account?</h3>
            <a href="Loginpage.php" class="u-border-2 u-border-custom-color-3 u-border-hover-custom-color-1 u-btn u-btn-round u-button-style u-hover-custom-color-3 u-none u-radius-50 u-btn-2">LOGIN</a>
        </div>
    </section>
