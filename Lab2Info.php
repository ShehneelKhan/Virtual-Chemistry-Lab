...
<div>
    <b><h1 style="text-align:center" > LAB 02 </h1></div></b>
...
<ul class="h3class2">
    ...
    <li> •	STEP 2: Attach thermometer with a glass tube filled with candle wax</li>
    <li> •	STEP 3: On the Bunsen burner until it reaches its melting point temperature.</li>
    <li> •	STEP 4: Now stop the burner and note the temperature.</li><br>
