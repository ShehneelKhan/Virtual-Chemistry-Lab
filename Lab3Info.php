...
<div>
    <b><h1 style="text-align:center" > LAB 03 </h1></div></b>
<h2 class="h3class2">Apparatus</h2>
<ul class="h3class2">
    <li> 1) Beaker</li>
    <li> 2) Thermometer</li>
    <li> 3) Test tube</li>
    <li> 4) Capillary tube</li>
    <li> 5) Tripod stand</li>
    <li> 6) Wire gauze</li>
    <li> 7) Bunsen burner</li>
    <li> 8) Stirrer</li>
    <li> 9) Rubber band</li>
</ul>
<br>
<h2 class="h3class2">Method</h2>
<ul class="h3class2">
    <h3>Method</h3>
    <h2>FIND THE BOILING POINT OF ETHYL ALCOHOL</h2>
    <li> •	STEP 1: Place all the apparatus .</li>
    <li> •	STEP 2: Attach the thermometer with a glass tube filled with Ethyl Alcohol and put a capillary tube inside a glass tube.</li>
    <li> •	STEP 3: On the Bunsen burner until it reaches its boiling point temperature and bubbles are coming from the capillary tube..</li>
    <li> •	STEP 4: Now stop the burner and note the temperature.</li>

</ul>
<br>

<h2 class="h3class2">Precautions</h2>
<ul class="h3class2">
    <li> 1) Water should be heated gently.</li>
    <li> 2) Stirring should be constant.</li>
    <li> 3) Thermometer bulb should not touch the walls and base of the beaker.</li>
    <li> 4) Too much or too little sample can be cause of error.</li>
    <li> 5) Adjust flame size so that the temperature rises no more than 2-3 degrees per minute.</li>
    <li> 6) A sample is only used once for melting point detection.</li>
    <li> 7) The graduated side of thermometer should face you.</li>
</ul>
