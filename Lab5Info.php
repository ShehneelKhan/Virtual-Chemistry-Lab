...
<div>
    <b><h1 style="text-align:center" > LAB 05 </h1></div></b>
<h2 class="h3class2">Apparatus</h2>
<ul class="h3class2">
    <li> 1) Measuring flask</li>
    <li> 2) Filter paper</li>
    <li> 3) Funnel</li>
    <li> 4) Beaker</li>
    <li> 5) Glass rod</li>
    <li> 6) Pipette</li>
    <li> 7) Physical balance</li>
    <li> 8) Weight box</li>
</ul>
<br>
...
<ul class="h3class2">
    ...
    <li> •	STEP 2: Put oxalic acid (6.3gm of 100ml or 15.75 gm for 250ml) into a beaker and dissolve it in a minimum quantity of distilled water.</li>
    <li> •	STEP 3: Take a 100ml flask for 6.3gm or 250 ml flask for 15.75gm oxalic acid.</li>
    <li> •	STEP 4: Transfer the solution from the beaker into the flask up to mark.</li>
    <li> •	STEP 5: Now this is a 0.5M solution of oxalic acid.</li>
    <br>
...
<ul class="h3class2">
    <li> 1) Physical balance must be adjusted.</li>
    <li> 2) Air bubbles must be removed.</li>
    <li> 3) The weighing should be accurate.</li>
    <li> 4) The beaker should be washed and washing should be added to solution of flask.</li>
    <li> 5) Final addition of water should be cautiously done.</li>
    <li> 6) Lower meniscus of solution should be read.</li>
</ul>
