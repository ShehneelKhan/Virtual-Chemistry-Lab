...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="color: rgb(1, 1, 15);">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li>
                <a class="nav-link active" href="lab-page.php">Labs</a>
            </li>
...
<!-- <div class="container">
    <br><br><br><br>
    <h2 align="center">Labs Detail</h2><br>
    <div class="row">
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 1</h3>
                    <p class="card-text">BENDING OF A GLASS TUBE METHOD  ETHYL ALCOHO.</p>
                    <a href="Lab1Info.php" class="btn btn-outline-light">Read More</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 2</h3>
                    <p class="card-text">FIND THE BOILING POINT OF ETHYL ALCOHOL.</p>
                    <a href="Lab2Info.php" class="btn btn-outline-light">Read More</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 3</h3>
                    <p class="card-text">FIND THE BOILING POINT OF ETHYL ALCOHOL.</p>
                    <a href="Lab3Info.php" class="btn btn-outline-light">Read More</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 4</h3>
                    <p class="card-text">FIND THE BOILING POINT OF ETHYL ALCOHOL.</p>
                    <a href="Lab4Info.php" class="btn btn-outline-light">Read</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 5</h3>
                    <p class="card-text">FIND THE BOILING POINT OF ETHYL ALCOHOL.</p>
                    <a href="Lab5Info.php" class="btn btn-outline-light">Read More</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 py-2">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <h3 class="card-title">Lab 6</h3>
                    <p class="card-text">FIND THE BOILING POINT OF ETHYL ALCOHOL.</p>
                    <a href="Lab6Info.php" class="btn btn-outline-light">Read More</a>
                </div>
            </div>
        </div>
    </div>
...
<br><br>
<center>
    <h1 class="display-4" align="center" style="color: #49AD09;">LABS</h1>
</center>
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-1</a>
                </div>
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-2</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-3</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-4</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-5</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-6</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-7</a>
                </div>
                <div class="col-auto d-none d-lg-block">
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="record-Page-1.php" class="stretched-link" style="color: #49ad09;">VCL-8</a>
                </div>
                <div class="col-auto d-none d-lg-block">
    ...
    <div class="container text-center text-md-left mt-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <!-- Content -->
                <h5 class="text-uppercase font-weight-bold">VCL</h5>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                    <a href="contact.php" style="color: #49AD09;">Contact</a>
                </p>
