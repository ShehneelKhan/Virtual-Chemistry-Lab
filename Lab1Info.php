...
<div>
    <b><h1 style="text-align:center" > LAB 01 </h1></div></b>
    <h2 class="h3class2">Apparatus</h2>
<ul class="h3class2">
    <li> 1) Glass tube</li>
    <li> 2) Small triangular file</li>
    <li> 3) Knife</li>
    <li> 4) Match box</li>
    <li> 5) Meter stick</li>
    <li> 6) Glass marking pencil</li>
    <li> 7) Bunsen burner</li>
</ul>
<br>
<h2 class="h3class2">Method</h2>
<ul class="h3class2">
    <h3> MAKING OUT A GET</h3>
    BENDING OF A GLASS TUBE
    METHOD
    <li> •	STEP 1: Place all the apparatus.</li>
    <li> •	STEP 2: Put glass rod on Bunsen burner and keeps rolling.</li>
    <li> •	STEP 3: On the Bunsen burner until the rod becomes soft.</li>
    <li> •	STEP 4: Now bend the rod.</li>
</ul>
<br>
<h2 class="h3class2">Precautions</h2>
<ul class="h3class2">
    <li> 1) The scratch on the tube should be sufficiently deep.</li>
    <li> 2) Pressing of thumbs should be with a uniform force.</li>
    <li> 3) Avoid too much heating, it may cause poor bends.</li>
    <li> 4) The tube should be continuously rotated while heating.</li>
    <li> 5) Do not keep the hot tube on the table.</li>
    <li> 6) Pull the ends of the tube by taking it out of the flame.</li>
    <li> 7) Heat the tube in the upper portion of the flame and continue rotating.</li>
    <li> 8) While drawing a jet the pulling apart of the glass tube should be immediate and carefully.</li>
    <li> 9) Never try to break the tube with simple bear hands.</li>
</ul>
